<template>
  <div id="DATE" class="calender" :class="{'calendar-range': mode == 'range'}">
    <div class="Path" style="justify-content: space-between;">
      <img @click="syHome" class="Path_1" style="margin:10px;margin-left:10px;" src="../assets/left.png" alt="">
      <img @click="syHome" class="Path_1" style="margin:10px;margin-left:300px;" src="../assets/queren.png" alt="">
    </div>
...
export default {
  ...
  methods: {
    syHome(){
      // this.$router.push({path:'/',query:{checkStart:this.checkStart,checkEnd:this.checkEnd}})
      this.$router.go(-1);
    },
    // 初始化日期转化 -/ 补0
    transfer(date) {
